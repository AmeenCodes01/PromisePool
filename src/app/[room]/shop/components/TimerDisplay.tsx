...
export default function TimerDisplay({SettingWithProps ,pause,resetDisabled,onPause,onSeshStart,onSeshReset}:{
...
SettingWithProps: () => React.JSX.Element;
  ...
  const {secLeft,workMin,mode,onChangeMode} = usePromiseStore((state) => state);
  ...
  return (
    <div className="items-center gap-4 flex flex-col justify-end py-6 flex-1  ">
            ...
            <div className="flex flex-row gap-4 ml-8   ">
              ...
              <button onClick={() => onSeshReset()} disabled={resetDisabled}>
              <TimerReset   />
                </button>
            </div>
          </div>
